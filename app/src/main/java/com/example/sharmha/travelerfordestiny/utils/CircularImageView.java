...
public class CircularImageView extends ImageView {
    ...
    private final int SHADOW_COLOR = Color.BLACK;
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        shadowEnabled = attributes.getBoolean(R.styleable.CircularImageView_shadow, SHADOW_ENABLED);
        ...
        if(hasSelector) {
            ...
            setSelectorColor(attributes.getColor(R.styleable.CircularImageView_selectorColor, Color.TRANSPARENT));
            setSelectorStrokeWidth(attributes.getDimensionPixelOffset(R.styleable.CircularImageView_selectorStrokeWidth, defaultSelectorSize));
            setSelectorStrokeColor(attributes.getColor(R.styleable.CircularImageView_selectorStrokeColor, Color.BLUE));
        }

        // Set shadow properties, if enabled
        if(shadowEnabled) {
            shadowRadius = attributes.getFloat(R.styleable.CircularImageView_shadowRadius, SHADOW_RADIUS);
            shadowDx = attributes.getFloat(R.styleable.CircularImageView_shadowDx, SHADOW_DX);
            shadowDy = attributes.getFloat(R.styleable.CircularImageView_shadowDy, SHADOW_DY);
            shadowColor = attributes.getColor(R.styleable.CircularImageView_shadowColor, SHADOW_COLOR);
    ...
    public Bitmap drawableToBitmap(Drawable drawable) {
        ...
        try {
            ...
            //TrimbleLog.e(TAG, "Encountered OutOfMemoryError while generating bitmap!");
            return null;
        }
    }
