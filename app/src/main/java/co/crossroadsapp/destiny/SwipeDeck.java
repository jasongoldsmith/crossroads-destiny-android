...
public class SwipeDeck extends FrameLayout {
    ...
    public void setAdapter(Adapter adapter) {
        ...
        if(!restoreInstanceState)nextAdapterCard = 0; currentTop=mAdapter.getCount()-1;
    ...
    private void addNextCard() {
        if (nextAdapterCard < mAdapter.getCount()) {
            ...
            if(currentTop>0) {
                ...
                currentTop=mAdapter.getCount()-1;
            }
        }
        setupTopCard();
    }
...
//            if (rightImageResource != 0) child.findViewById(rightImageResource).setAlpha(0);
    ...
    private void positionItem(int index) {
        ...
        if(nextAdapterCard==1) {
            child.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.slide_in_from_top));
        } else {
            child.animate()
        ...
        if (child != null) {
            ...
            swipeListener = new SwipeListener(child, new SwipeListener.SwipeCallback() {
                ...
                public void cardSwipedLeft() {
                    ...
                    int positionInAdapter = mAdapter.getCount()-1;
                    removeTopCard();
